                ...
                <Container id="home-content" className="text-left text-slate-400 !pt-36 !pr-0 !pb-8 z-0 ">
                    <Row>
                        <Col md={7} className="!pt-20">
                            <h1 style={{ paddingBottom: 15 }} id="heading" className="!text-4xl !pl-12 "> Hi There!{" "} <span className="wave" role="img" aria-labelledby="wave">👋🏻 </span> </h1>
                            <h1 id="heading-name" className="!pl-12 !text-4xl"> I'M <strong className="main-name"> Manny Fong</strong></h1>
